...
>
      ...
      <div className="flex flex-col justify-center items-center text-white text-center h-screen bg-black/50">
        ...
        <button className="bg-blue-600 hover:bg-blue-700 px-6 py-3 rounded-xl text-white text-lg transition-all shadow-md">
          Plan Your Trip
        </button>
      </div>
    </div>
  ...
  return (
    <main className="min-h-screen flex items-center justify-center">
      <div className="text-center">
        <h1 className="text-4xl font-bold mb-4">Welcome to Star Tourism 🌍</h1>
        <p className="text-lg">Explore. Travel. Live.</p>
      </div>
    </main>
  );
}
